...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(976, 783)
        icon = QIcon()
        icon.addFile(u":/images/resource/image/mansaranna logo.jpg", QSize(), QIcon.Normal, QIcon.Off)
...
"	border-image: url(:/images/resource/image/mansaranna logo.jpg) 0 -200 -100 0 stretch stretch;\n"
"}")
...
"}")
        ...
        self.gridLayout_3.addWidget(self.wishlistIDSaveBtn, 2, 3, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 44, QSizePolicy.Minimum, QSizePolicy.Expanding)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.lineEdit_wishlistID, 2, 2, 1, 1)

        self.label_3 = QLabel(self.settingPage)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setTextFormat(Qt.AutoText)
        self.label_3.setPixmap(QPixmap(u":/images/resource/image/Screenshot 2023-10-23 172645.png"))
